...
[![Idea?](https://img.shields.io/badge/💡_Idea%3F-Open_Issue-FFD93D?style=flat-square)](https://github.com/Lirsakura/skills-hub/issues/new)
...
```bash
git clone https://github.com/Lirsakura/skills-hub.git
cp skills-hub/agents/advisor-agent.md  ~/.config/opencode/agents/
cp -r skills-hub/skills/advisor-agent/ ~/.config/opencode/skills/
...
**开 [Issue](https://github.com/Lirsakura/skills-hub/issues/new) 就行。哪怕一句 "要是有个 XX 就好了" 也够。**
...
**[Open an Issue](https://github.com/Lirsakura/skills-hub/issues/new). Even "wish there was a XX" is enough.**
...
💬 **[Open an Issue](https://github.com/Lirsakura/skills-hub/issues/new) — 任何想法我都看 · I read them all**
